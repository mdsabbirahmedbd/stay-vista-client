...
const UpRoomFoorm = ({date, handleDates, loading, roomData, handleImageUpload, handleSubmit, setRoomData }) => {
          ...
          <div className="space-y-1 text-sm">
            ...
            <textarea
              ...
              value={roomData?.description}
                onChange={(e) => setRoomData(e.target.description)}
              name="description"
            ></textarea>
          </div>
        </div>
